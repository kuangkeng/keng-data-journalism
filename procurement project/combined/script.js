...
function drawVisualization() {
  ...
  ['<p class=topcell>Company','<p class=topcell>Value (RM)', '<p class=topcell>Percentage of total contract value', '<p class=topcell>No. of contract', '<p class=topcell>Company registration no.', '<p class=topcell>Registration no. with MOF'],
...
//code for d3 sankey chart starts here 
